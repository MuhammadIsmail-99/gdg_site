...
function loadAllTeamsForMembersPage() {
    ...
    const teamOrder = ['Executives', 'Gen AI', 'Web & App', 'Data Science', 'Graphics', 'Social Media & Marketing', 'Event Management'];
    const teamConfig = {
        'Executives': {
            color: 'blue',
            icon: 'crown',
        ...
        'Gen AI': {
            color: 'indigo',
            icon: 'brain',
            description: 'Exploring Generative AI, LLMs, and future technologies'
        },
        'Web & App': {
            color: 'blue',
            icon: 'code',
        ...
        'Data Science': {
            color: 'green',
            icon: 'database',
            description: 'Uncovering insights with data analysis and machine learning'
        },
        'Graphics': {
            color: 'purple',
            icon: 'palette',
...
function createFilterButtons() {
    ...
    const teams = ['All', 'Executives', 'Gen AI', 'Web & App', 'Data Science', 'Graphics', 'Social Media & Marketing', 'Event Management'];
    const colors = ['gray', 'blue', 'indigo', 'blue', 'green', 'purple', 'pink', 'yellow'];

    teams.forEach((team, index) => {
        const button = document.createElement('button');
        const color = colors[index] || 'gray';
        button.className = `px-4 py-2 rounded-full text-sm font-medium transition-all ${index === 0 ? `bg-${color}-600 text-white` : `bg-${color}-100 text-${color}-700 hover:bg-${color}-200`
            }`;
